...
class Robot:
    ...
    One of the robots
    """
    def __init__(self, name=None,ore=0, clay=0, obsidian=0):
        self.name = name
        self.ore = ore
        self.clay = clay
    ...
    def __str__(self):
        return f"Type:{self.name},Ore:{self.ore},Clay:{self.clay},Obsidian:{self.obsidian}"


# Read in the blueprints
file_name = r"day/19/input_example"
blueprints=[]
with open(file_name, "r") as file:
    ...
    for line in file:
        ...
        for part in parts:
            ...
            blueprint.append(Robot(name,ore,clay,obsidian))
